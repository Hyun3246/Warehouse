...
def getMeansAndSDs(population, sample, verbose = False):
    ...
    if verbose:
        ...
        pylab.figure()
        makeHist(sample, 'Daily High 1961-2015, Sample\n' + '(mean = ' + str(round(sampleMean, 2)) + ')', 'Degrees C', 'Number Days')   
...
plotDiffs(sampleSizes, diffs,
         'Sample SD vs Population SD, Temperatures', label = 'High temps')
...
def compareDists():
    ...
    plotDiffs(sampleSizes, udiffs, 'Sample SD vs Population SD', 'Uniform population', 'm')
    plotDiffs(sampleSizes, ndiffs, 'Sample SD vs Population SD', 'Normal population', 'b')
    plotDiffs(sampleSizes, ediffs, 'Sample SD vs Population SD', 'Exponential population', 'r')
...
for size in popSizes:
   ...
   plotDiffs(sampleSizes, ediffs, 'Sample SD vs Population SD, Uniform', 'Population size = ' + str(size))
